const About = () => {
  return (
      <div className="relative overflow-hidden border rounded-xl border-amber-50 shadow">
        <div className="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
          <div aria-hidden="true" className="flex -z-1 absolute start-0">
            <div className="bg-purple-200 opacity-20 blur-3xl w-[1036px] h-75 dark:bg-purple-900 dark:opacity-20"></div>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-6 lg:gap-8 lg:items-center">
            ...
            <div className="lg:col-span-4">
              <blockquote>
                ...
                <p className="text-xl font-medium text-gray-800 lg:text-2xl lg:leading-normal dark:text-neutral-800">
